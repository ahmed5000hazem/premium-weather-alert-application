...
use App\Livewire\Pages\WeatherAlertsPage;
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('weather-alerts', WeatherAlertsPage::class)->middleware(EnsureClientHasActiveSubscription::class)->name('weather-alerts');
