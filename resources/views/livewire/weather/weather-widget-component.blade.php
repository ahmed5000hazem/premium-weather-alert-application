    ...
    @else
        <h2 class="text-md mb-2 px-4 pt-4">
            <div class="flex justify-between">
                ...
                <div>
                    <span class="text-sm"> last updated {{ Carbon\Carbon::parse($weather->current->last_updated_epoch)->format('H:i') }} </span>
                </div>
        ...
        <div class="flex justify-center items-center p-4 mt-4">
            <img class="w-32" src="{{ $weather->current->condition->icon }}" alt="">
        </div>
        <div class="text-md pt-4 pb-4 px-4">
            <div class="flex justify-between items-center">
                ...
                <div>
                    <p class="text-6xl text-yellow-400"> {{ $weather->current->temp_c }}° </p>
                    @if ($weather->forecast->forecastday[0])
